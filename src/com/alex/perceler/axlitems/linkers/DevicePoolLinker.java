...
import com.alex.perceler.soap.items.LocalRouteGroup;
...
public class DevicePoolLinker extends AXLItemLinker
	...
	public void doResetVersion105() throws Exception
		...
		com.cisco.axl.api._10.StandardResponse resp = Variables.getAXLConnectionToCUCMV105().resetDevicePool(req);//We send the request to the CUCM
		}
	/*************/
